                        ...
                        <div class="flex items-center justify-between mb-5">
                            <div class="flex flex-col font-bold w-2/6 px-2">
                                ...
                                <input type="text"
                                    ...
                                    name="amount"
                                    placeholder="1.00"
                                    class="py-3 px-5 rounded focus-outline-noe text-gray-600 focus:text-gray-600 border border-4">
                            </div>
                            <div class="flex flex-col font-bold w-4/6 px-2">
                                <label for="from" class="mb-3 text-black">
                                    From
                                </label>
                                <select name="from" class="py-3 px-5 rounded focus-outline-noe text-gray-600 focus:text-gray-600 border border-4">
                            ...
                            <div class="flex flex-col font-bold w-4/6 px-2">
                                ...
                                <select name="to" class="py-3 px-5 rounded focus-outline-noe text-gray-600 focus:text-gray-600 border border-4">
                                    @foreach ($codes as $code => $value )
